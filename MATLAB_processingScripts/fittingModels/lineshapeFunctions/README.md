...
|---|---|---|
| `RF_superlorentzian.m` | Super-Lorentzian | Super-Lorentzian lineshape computed by numerical integration over orientation angles (Bieri & Scheffler, MRM 2006). Appropriate for modeling the semisolid pool in tissue. |
